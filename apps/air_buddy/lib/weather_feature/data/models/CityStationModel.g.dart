...
Iaqi _$IaqiFromJson(Map<String, dynamic> json) => Iaqi(
      ...
      no2: json['no2'] == null
          ? null
          : H.fromJson(json['no2'] as Map<String, dynamic>),
      o3: json['o3'] == null
          ? null
          : H.fromJson(json['o3'] as Map<String, dynamic>),
      p: json['p'] == null
          ? null
          : H.fromJson(json['p'] as Map<String, dynamic>),
      pm10: json['pm10'] == null
          ? null
          : H.fromJson(json['pm10'] as Map<String, dynamic>),
      pm25: json['pm25'] == null
          ? null
          : H.fromJson(json['pm25'] as Map<String, dynamic>),
      so2: json['so2'] == null
          ? null
          : H.fromJson(json['so2'] as Map<String, dynamic>),
      t: json['t'] == null
          ? null
          : H.fromJson(json['t'] as Map<String, dynamic>),
      w: json['w'] == null
          ? null
          : H.fromJson(json['w'] as Map<String, dynamic>),
    );
