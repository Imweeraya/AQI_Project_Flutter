...
class StationRepository extends IStationRepository{
  ...
  Future<StationModel> getStation() async {
    final weather = await httpService.get('/v2/map/bounds?latlng=21.781492109878354,95.21399400612671,5.135168114067062,112.39991160362918&networks=all&token=c446149c4593b2dd221b9d37f1b7612a658f4ccc');
